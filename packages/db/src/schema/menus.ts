...
import { prepGroups, prepLists } from "./preparations";
...
export const menuItemAllergiesRelations = relations(
  menuItemAllergies,
  ({ one }) => ({
    company: one(companies, {
      fields: [menuItemAllergies.companyId],
      references: [companies.id],
    }),
    menuItem: one(menuItems, {
      fields: [menuItemAllergies.menuItemId],
      references: [menuItems.id],
    }),
    allergy: one(allergies, {
      fields: [menuItemAllergies.allergyId],
